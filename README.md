...
In the files, Contact list is a Django project and contacts is Django web app.
...
Read the 'How to use' section in the above link to know how to embed them in the website.
...
Credits:
This project is made by Mukesh Javvaji
CSE STudent 
GITAM university.
